...
const IndustriesGrid = ({ data }) => {
      ...
      return (
            <section className="py-14 sm:py-16 md:py-20 bg-[#F8F9FC]">
                  <div className="max-w-7xl mx-auto px-4 sm:px-6">
                        ...
                        <div className="mb-10 sm:mb-12 md:mb-14">
                              ...
                              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-slate-900 mt-2 sm:mt-3 mb-3 sm:mb-4 leading-tight">
                                    {data.heading}
                              </h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5">
                              {data.items.map((item, idx) => {
                                    ...
                                    return (
                                          <div
                                                key={idx}
                                                className="bg-white p-4 sm:p-5 rounded-xl border border-slate-200 flex items-start gap-3 sm:gap-4 transition-all duration-300 hover:shadow-md hover:-translate-y-[2px]"
                                          >
                                                {/* Icon */}
                                                <div className="bg-slate-50 p-2 sm:p-2.5 rounded-lg shrink-0">
