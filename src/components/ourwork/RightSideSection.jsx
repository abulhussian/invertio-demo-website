            ...
            <section className="w-full bg-[#F4F6FA] py-20">
                  <div className="flex flex-col lg:flex-row items-center gap-8">
                        ...
                        <div className="flex-1 max-w-xl">
                              <h2 className="text-lg sm:text-xl md:text-3xl lg:text-4xl font-semibold text-[#0F172A] mb-4">
                                    {title}
                              </h2>

                              <p className="text-gray-600 leading-relaxed text-[14px] sm:text-[15px] md:text-[16px] mb-4">
                                    {description}
                              </p>
